...
{{--        <div>
            ...
            <!-- Код для раздела меню Блог-Категории-Материалы, котрый посоветовал Арсен с сайта Tailewind-->
            <div class="relative inline-block text-left">
                ...
                <div class="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                  <div class="py-1" role="none">
                    ...
                    <a href="{{route('admin.category.index')}}" class="text-gray-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-0">Категории</a>
                    <a href="#" class="text-gray-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-1">Материалы</a>
                  </div>
                </div>
            </div>
